...
import 'package:academy/views/CourseInfoCubit/CourseInfo_cubit.dart';
...
class QuizPage extends StatefulWidget {
  QuizPage({required this.id,required this.courseId,required this.context}) : super();
  final String id;
  final courseId;
  final context;
                              ...
                              child: Transform.scale(
                                ...
                                child: BorderedButton(
                                    ...
                                    onPress: () {
                                      ...
                                      ReviewCubit cubit1=ReviewCubit.get(widget.context);
