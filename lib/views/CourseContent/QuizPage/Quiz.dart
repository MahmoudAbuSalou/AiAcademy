    ...
    return SafeArea(
      child: Scaffold(
        body: BlocProvider(
          ...
          create: (context) =>
              QuizCubit()..getQuiz(id: widget.id, context: context)..startTimer(),
            ...
            builder: (context, state) {
              ...
              if(cubit.test) {
                                ...
                                Container(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      String x = cubit.quiz.questions[index]
                                          .title;

                                      return Column(
                                        children: [
                                          question(
                                            answers: cubit.quiz.questions[index]
                                                .options,
                                            count: index + 1,
                                            questionTitle: x,
                                            type: cubit.quiz.questions[index]
                                                .type,
                                            point: cubit.quiz.questions[index]
                                                .point,
                                            idQues: cubit.quiz.questions[index]
                                                .id,
                                            Review: true,
                                          ),
                                          if (index !=
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    ListTile(
                                        ...
                                        '  علامة النجاح:${cubit.quiz.results!
                                            .passingGrade}  '), /*${cubit.quiz.results!.passingGrade}*/
                                  ],
                                ),
                              ),
                              SizedBox(
                ...
                //ResultQuiz
                   ...
                   finalResult!.passingGrade= cubit.convert(finalResult.passingGrade!);

                    return Column(
                      children: [
                        MyAppBar(title: 'نتيجة الاختبار',),
                        SizedBox(
                          height: 200.h,
                        ),
                        Transform.scale(
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              color:     ((finalResult.resul!)>=int.parse(finalResult.passingGrade!))?Colors.green:Colors.red,
                          ...
                          child: Center(
                            child: Text(
                              ((finalResult.resul!)>=int.parse(finalResult.passingGrade!))?'لقد نجحت':'لقد أخفقت ',
                              style: GoogleFonts.tajawal(
                                  textStyle: TextStyle(
                                      fontWeight: FontWeight.bold,
                                      fontSize: 70.sp,
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              Row(
                                children: [
                                  Text('Time Spend',style: GoogleFonts.tajawal(
                                      fontSize: 50.sp
                                  ),),
                                  Spacer(),
                                  Text('${finalResult.timeSpend}',style: GoogleFonts.tajawal(
                                      fontSize: 50.sp
                                  ),)
                                ],
                              ),
                              ...
                              Row(
                                children: [
                                  Text('Points',style: GoogleFonts.tajawal(
                                      fontSize: 50.sp
                                  ),),
                                  Spacer(),
                                  Text('${finalResult.userMark}',style: GoogleFonts.tajawal(
                                      fontSize: 50.sp
                                  ),)
                                ],
                              ),
                              ...
                              Row(
                                children: [
                                  Text('الأسئلة',style: GoogleFonts.tajawal(
                                      fontSize: 50.sp
                                  ),),
                                  Spacer(),
                                  Text('${finalResult.questionCount}',style: GoogleFonts.tajawal(
                                      fontSize: 50.sp
                                  ),)
                                ],
                              ),
                              ...
                              Row(
                                children: [
                                  Text('Correct',style: GoogleFonts.tajawal(
                                      fontSize: 50.sp
                                  ),),
                                  Spacer(),
                                  Text('${finalResult.questionCorrect}',style: GoogleFonts.tajawal(
                                      fontSize: 50.sp
                                  ),)
                                ],
                              ),
                              ...
                              Row(
                                children: [
                                  Text('Wrong',style: GoogleFonts.tajawal(
                                      fontSize: 50.sp
                                  ),),
                                  Spacer(),
                                  Text('${finalResult.questionWrong}',style: GoogleFonts.tajawal(
                                      fontSize: 50.sp
                                  ),)
                                ],
                              ),
                              ...
                              Row(
                                children: [
                                  Text('Skipped',style: GoogleFonts.tajawal(
                                      fontSize: 50.sp
                                  ),),
                                  Spacer(),
                                  Text('${finalResult.questionEmpty}',style: GoogleFonts.tajawal(
                                      fontSize: 50.sp
                                  ),)
                                ],
                              ),
                        ...
                        children: [
                          (cubit.quiz.results?.retakeCount>0 && cubit.quiz.results?.retaken<cubit.quiz.results?.retakeCount)?
                            Padding(
                              ...
                              child: FlatButton(
                                ...
                                child: Text('إعادة ${cubit.quiz.results?.retakeCount-cubit.quiz.results?.retaken}',style: GoogleFonts.tajawal(
                           ...
                           (cubit.quiz.results?.reviewQuestions==true)?
                            Padding(
                              ...
                              child: FlatButton(
                                ...
                                color: kSwatchColor,
                                child: Text('مراجعة',style: GoogleFonts.tajawal(
                                  color: Colors.white,
                                  fontSize: 50.sp
