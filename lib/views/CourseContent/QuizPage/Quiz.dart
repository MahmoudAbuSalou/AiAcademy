...
class QuizPage extends StatefulWidget {
  QuizPage({required this.id,required this.courseId}) : super();
  final String id;
  final courseId;
...
class _QuizPageState extends State<QuizPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: WillPopScope(
        onWillPop:() async {
          Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => CourseInfo(id: widget.courseId),));
          return true;
        },
        child: Scaffold(
          body: BlocProvider(
                      ...
                      return ConditionalBuilder(
                        ...
                        builder: (context) {
                          return SingleChildScrollView(
                            child: Column(
                              children: [
                                MyAppBar(title: 'التقييم',BoolNextPage: false,id: widget.courseId),
                                SizedBox(
                                  height: 25.h,
                                ),
                                Container(
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    Padding(
                                      padding:
                                      EdgeInsets.only(left: 25.w,right: 25.w,bottom: 5),
                                      child: const Icon(
                          ...
                          children: [
                            FittedBox(
                              ...
                              title: '${cubit.quiz.title}',
                                  BoolNextPage: false,id: widget.courseId,
                            )),
